...
public class LocalDiscovery extends Thread {
    ...
    private Identity ed25519KeyPair;

    public LocalDiscovery(String broadcastAddress, String ipAddress, int port, Identity ed25519KeyPair) {
        this.port = port;
        this.broadcastAddress = broadcastAddress;
        this.ed25519KeyPair = ed25519KeyPair;
        if (ipAddress != null) {
            broadcastMessage = "net:" + ipAddress + ":" + port + "~shs:" + ed25519KeyPair.getString();
        }
    }
        ...
        while (true) {
            ...
            try {
                if (receiverSocket != null) {
                    ...
                    try {
                        if (!data[3].equals(ed25519KeyPair.getString())) {
